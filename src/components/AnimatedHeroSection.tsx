  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden bg-white !opacity-100 lg:!py-3">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-8 md:p-12 lg:p-16 !px-[65px] !py-[110px] !rounded-[25px] !w-[1051px] !h-[712px]" style={{ backgroundColor: "rgb(247, 248, 212)" }}>
          {/* Left Side - Text Content */}
          <div className="z-10 space-y-6">
            <h1 className="text-4xl md:text-5xl text-gray-900 leading-tight !w-[460px] !h-[325px] lg:!text-[63px] !font-bold lg:!text-black !not-italic !border-solid">
